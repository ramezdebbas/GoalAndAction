(function () {
    ...
    WinJS.Namespace.define("Application", {
        ...
        navigateAddGroup: function () {
            var home = document.querySelector("#contenthost").winControl.home;
            var loc = nav.location;

            if (loc !== "/pages/addGroup/addGroup.html") {
                nav.navigate("/pages/addGroup/addGroup.html");
            }
        },

        navigateAddTask: function () {
            var home = document.querySelector("#contenthost").winControl.home;
            var loc = nav.location;

            if (loc !== "/pages/addTask/addTask.html") {
                nav.navigate("/pages/addTask/addTask.html");
            }
        },
    });
})();
